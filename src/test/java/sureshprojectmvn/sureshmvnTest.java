...
import sureshprojectmvn.sureshmvn;
...
public class sureshmvnTest {
	...
	public void setup() throws ResourceInitializationException, FileNotFoundException {
		...
		reader = createReaderDescription(sureshmvn.class, sureshmvn.PARAM_FILE_DIRECTORY, dir);
